...
seed=1
id=3
mixing="Mixing/results_year_${seed}.csv"
mixsat="MIXSAT/results_year_${seed}.csv"
# mixing="mixing_solver/results_year_2.csv"
# mixsat="mixsat_solver/results_year_2.csv"
gat="LS-GAT/results_${id}_year_${seed}.csv"
sgat="LS-SGAT/results_11_year_${seed}.csv"
# gat="LS-SGAT/results_10_year_${seed}.csv"
fouriersat="FourierSAT/results_year_${seed}.csv"
